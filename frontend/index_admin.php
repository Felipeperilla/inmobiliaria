                ...
                <ul class="nav navbar-nav">
                    ...
                    <li role="presentation" class="dropdown">
                        ...
                        Clientes <span class="caret"></span>
                            ...
                            <ul class="dropdown-menu">                            
                                <li><a href="../backend/Clientes/CrearCliente.php">Ingresar Cliente</a></li>
                                <li role="separator" class="divider"></li>
                                <li><a href="../backend/Clientes/ListarClientes.php">Ver Clientes</a></li>       
                            </ul>    
                    </li>

                    <li>
                        <a href="../backend/Inmueble/Listar_inmueble.php">Inmuebles</a>
                    </li>

                    <li>
                        <a href="../backend/Facturas/ListarFacturas.php">Facturas</a>        
                    </li>                        
                        ...
                        <?php echo $_SESSION["USUARIO"]?> <span class="caret"></span>
                            ...
                            <ul class="dropdown-menu"> 
                                <li><a href="../backend/Secretaria/CrearSecretaria.php">Registrar Secretaria</a></li>
                                <li><a href="../backend/Secretaria/VerSecretaria.php">Ver Secretarias</a></li>
                                <li role="separator" class="divider"></li>
