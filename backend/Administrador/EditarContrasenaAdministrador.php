        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li role="presentation" ><a href="../Administrador/VerAdministrador.php">Administradores</a></li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        </div>
...
if (isset($_POST["bot_actualizar"])) {
    ...
    $modifica->set_actualizar_contrasena_administrador($ID_PERSONA, $CONTRASENA);
} else {
...
<body class="blurBg-false" style="background-color:#ffffff">
    <div class="contenedor">
        ...
        <form class="formoid-solid-red"name="formulariocontrasenasecretaria" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post" ><div class="title"><h1>Modificar Contraseña Administrador</h1></div>
