        ...
        foreach ($array as $registro):
            ...
            <tbody class="buscar">
                <tr>
                    ...
                    <td class='bot'>
                        <a href="EliminarSecretaria.php?id=<?php echo $registro->ID_PERSONA; ?>">
                    ...
                    <td class="bot"><a href="EditarContrasenaSecretaria.php?ID_PERSONA=<?php echo $registro->ID_PERSONA; ?> & CONTRASENA=<?php echo $registro->CONTRASENA; ?>"><input type='button' name='up' onclick="transformarEnEditable(this)" id='up' value='Cambiar Contraseña'></a></td>
                </tr>
            </tbody>
            <?php
        endforeach;
